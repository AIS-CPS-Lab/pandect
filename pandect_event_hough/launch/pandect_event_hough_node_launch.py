...
def generate_launch_description():
    ...
    args = [
        DeclareLaunchArgument("name", default_value="pandect_event_hough_node", description="node name"),
        DeclareLaunchArgument("namespace", default_value="", description="node namespace"),
        DeclareLaunchArgument("params", default_value=os.path.join(get_package_share_directory("pandect_event_hough"), "config", "params.yml"), description="path to parameter file"),
